...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("bruh moment", 2000, 1000, 
                                         Color.white);
        }
     ...
     * Odstrani plátno.
     */
    public static void odstranPlatno() {
        Platno.platnoSingleton.setVisible(false);
        Platno.platnoSingleton = null;
    }
     ...
     */
    public void setFont() {
        Font names = new Font("Arial", Font.BOLD, 40);
        graphic.setFont(names);       
    }
    /*
     * Zmení font stringu pre čísla.
     */
    public void setFont2() {
        Font numbers = new Font("Arial", Font.PLAIN, 40);
        graphic.setFont(numbers);       
    }
    /*
     * Zmení font stringu pre koniec hry.
     */
    public void setFont3() {
        Font ded = new Font("Arial", Font.BOLD, 300);
        graphic.setFont(ded);
    }
